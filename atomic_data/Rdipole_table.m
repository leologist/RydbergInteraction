...
if isempty(qn_Rdipole_global_table)
    ...
    if n1~=-999
        ...
        load Rdipole_table_n150_n150_L04_L04_J2_J2;
    else
        % Rebuild the table
        ...
        % remeber to save: save('Rdipole_table_n100_n100_L04_L04_J2_J2','Rdipole_global_table')
        %save('Rdipole_table_n150_n150_L04_L04_J2_J2','Rdipole_global_table')
    end
    ...
    qn_Rdipole_global_table=sparse(1e9,1);
